...
import stylesCss from 'themes/permission-tracker/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_permission-tracker_componentCss']) {
    
    document['_vaadintheme_permission-tracker_componentCss'] = true;
  }
