 ...
 * The users_authorities variable is used to store the authorities of the user.
 * The DN variable is used to store the DN of the user.
 * The ganzer_Name variable is used to store the full name of the user.
 ...
 * The mail variable is used to store the email address of the user.
 */
@NoArgsConstructor
@Getter
@Setter
